...
#########################CLEARML Project detail############################
#task will create project name and task name either training/serving
from clearml.automation.controller import PipelineDecorator
from clearml import TaskTypes
from clearml import Task
task = Task.init(project_name='Initial_script', task_name='Training_script')
##########################################################################


###CONFIG
@PipelineDecorator.component(return_values=['cfg'], cache=True, task_type=TaskTypes.data_processing)
...
###ACCELERATOR
@PipelineDecorator.component(return_values=['accelerator'], cache=True, task_type=TaskTypes.controller)
...
###Data-Loader
@PipelineDecorator.component(return_values=['raw_datasets'], cache=True, task_type=TaskTypes.data_processing)
...
###tokenizer,model
@PipelineDecorator.component(return_values=['tokenizer','model'], cache=True, task_type=TaskTypes.data_processing)
...
###OPTIMIZER
@PipelineDecorator.component(return_values=['optimizer_grouped_parameters','lr'], cache=True, task_type=TaskTypes.optimizer)
...
@PipelineDecorator.component(return_values=['tokenized_datasets'], cache=True, task_type=TaskTypes.data_processing)
    ...
    for epoch in range(starting_epoch, cfg.training.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if step % cfg.training.eval_every == 0:
                ...
                epoch_dir = f"epoch_main_most_recent"
